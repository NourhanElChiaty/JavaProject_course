	...
	public class secondPage extends JFrame {
		...
		public secondPage() {
			...
			txtrName.setFont(new Font("Arial", Font.PLAIN, 18));
			...
			txtrName_1_1.setFont(new Font("Arial", Font.PLAIN, 18));
			...
			txtrName_1_1_1.setFont(new Font("Arial", Font.PLAIN, 18));
			...
			txtrName_1_1_2.setFont(new Font("Arial", Font.PLAIN, 18));
			...
			lblDoYouHave.setFont(new Font("Arial", Font.PLAIN, 20));
			...
			checkbox_1.setFont(new Font("Arial", Font.PLAIN, 18));
