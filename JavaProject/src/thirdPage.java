...
public class thirdPage extends JFrame {
	...
	public thirdPage(int scoure,int job) {
		...
		txtpnDoYouAlways.setFont(new Font("Arial", Font.PLAIN, 18));
		...
		textPane_1_1.setFont(new Font("Arial", Font.PLAIN, 18));
		...
		textPane_1_1_1_1.setText("Are you in closed places frequently ?");
