	...
	public class FirstPage extends JFrame {
		...
		public FirstPage() {
			...
			txtrCheckYourselfAgainst.setFont(new Font("Arial", Font.PLAIN, 25));
			...
			txtrCoronaCheck.setFont(new Font("Arial", Font.BOLD, 35));
			...
			lblNewLabel.setBounds(280, 82, 807, 273);
			lblNewLabel.setIcon(new ImageIcon("C:\\Users\\v18nhamid7\\eclipse-workspace\\JavaProject\\img\\download.png"));
